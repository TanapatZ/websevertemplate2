...
public class OfficeService {
   ...
   private OfficeRepository officeRepository;
    ...
    public Office createOffice(Office office) {
        ...
        if (existingOffice != null) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    String.format("Office with code %s already exists", office.getOfficeCode()));
        }
    ...
    public Office updateOffice(Office office) {
        ...
        if (existingOffice == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND,
                    String.format("Office with code %s does not exists", office.getOfficeCode()));
        }
        return officeRepository.save(office);
    ...
    public Office deleteOffice(String  officeCode) {
        ...
        if (existingOffice == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND,
                    String.format("Office with code %s does not exists", officeCode));
